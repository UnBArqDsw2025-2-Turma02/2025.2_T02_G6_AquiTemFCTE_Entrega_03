...
<p style="text-align: center;">Tabela 1: Participantes da implementação do Builder</p>
...
## 4. Modelagem do Builder

<p align="center" style="font-size: 12;">
Figura 1: Diagrama do Builder
</p>
...
#### 5.2.1. Interface ProdutoBuilder (Builder)
...
#### 5.2.3. Classe GerenciamentoDeCriacaoProdutos (Director)
...
#### 5.2.4. Classes Builders Concretos
...
### 6.3. Criação de Produto Básico (Troca)
...
### 6.4. Criação de Produto Básico (Venda)
...
### 6.5. Criação de Produto Completo
...
```json
{
  ...
  "itensDeInteresseParaTroca": "Notebook Acer Nitro 5"
}
```

### 6.6. Endpoints Disponíveis
...
### 6.8. Scripts Disponíveis

- `npm start`: Inicia o servidor em modo desenvolvimento com hot reload

## 7. Vídeo de Execução do Código e Local do Código:

### 7.1. Vídeo de Execução:

<iframe width="560" height="315" src="https://www.youtube.com/embed/lN-k_yNLNDI?si=tVIhHu1qHK3oZjM8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

### 7.2. Local do Builder no Repositório
...
### 8.1. Justificativas e Senso Crítico
...
### 8.2. Comentários sobre o Trabalho em Equipe
...
| ------ | ---------- | ---------------------------------------- | ------------------------------------- | ----------- | ------------------------------------------------------------------ |
| 1.0    | 13/10/2025 | Criação do Diagrama                      | [Daniel Rodrigues](https://github.com/DanielRogs) | [Igor Justino](https://github.com/IgorJustino)        | Revisão sem erros identificados, seções adicionais são necessários |
| 1.1    | 13/10/2025 | Implementação completa do padrão Builder | [Daniel Rodrigues](https://github.com/DanielRogs)                 | [Igor Justino](https://github.com/IgorJustino)        | Sem erro no que foi produzido, mas falta video e um link para indicar a pasta da implementação do GOF |
| 1.2    | 13/10/2025 | Inserção do Código GOF | [Daniel Rodrigues](https://github.com/DanielRogs) | [Igor Justino](https://github.com/IgorJustino) | Sem erro no que foi produzido, falta inserção do video |
| 1.3    | 13/10/2025 | Inserção do Vídeo do Builder | [Daniel Rodrigues](https://github.com/DanielRogs) | [Igor Justino](https://github.com/IgorJustino) | Números dos tópicos estão incorretos |
| 1.4    | 13/10/2025 | Corrige numeral dos topicos | [Daniel Rodrigues](https://github.com/DanielRogs) |  [Davi Camilo](https://github.com/Davicamilo23) | Sem erro no que foi produzido |
