...
| 2.0    | 13/10/2025 | Implementação completa do padrão Builder | [Daniel Rodrigues]()                  | []()        | Adição da implementação, documentação técnica e guia de execução   |
