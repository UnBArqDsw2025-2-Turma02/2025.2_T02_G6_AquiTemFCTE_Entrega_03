...
Este documento apresenta a aplicação do padrão de projeto comportamental Command, um dos GoF Comportamenatis, no contexto do sistema de trocas e vendas entre alunos. 
...
O objetivo principal é encapsular todos os dados necessários para executar uma ação em um único objeto.
...
| 1.1   | 23/10/2025 | Refatoração da documentação, inserção dos códigos e inserção de vídeo. | [Caio Sabino](https://github.com/caiomsabino) | [Felipe Campelo](https://github.com/felipeacampelo) | |