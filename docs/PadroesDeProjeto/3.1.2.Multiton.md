...
<p style="text-align: center;">Tabela 1: Participantes da implementação do Multiton</p>
...
### 6.2. Aplicabilidade em Sistemas Reais
...
## 8. Demonstração do Código sendo Executado
