# Padrão de Projeto GoF Estrutural Composite
...
### 3. Implementação de Objetos Composto (Composite)
...
| -- | -- | -- | -- | -- | -- |
| 1.0 | 18/10/2025 | Desenvolvimento inicial do documento com Introdução | [Caio Sabino](https://github.com/caiomsabino) | [Daniel Rodrigues](https://github.com/DanielRogs) |  |
