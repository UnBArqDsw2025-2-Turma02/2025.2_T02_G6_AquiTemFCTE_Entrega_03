...
**1.** Análise do diagrama de classes e pacotes: Após o estudo do conteúdo, o diagrama de classes e de pacotes, produzidos anteriormente, foram analisados pelos integrantes com a intenção de identificar onde o padrão GoF Mediator poderia ser aplicado, já considerando o [refinamento feito sobre o diagrama de classes](https://unbarqdsw2025-2-turma02.github.io/2025.2_T02_G6_AquiTemFCTE_Entrega_03/#/./Extra/3.5.5.DiagramaClasses).

**2.** Elaboração do diagrama: Após decidido pelos integrantes responsáveis que as classes a serem trabalhadas seriam a de Login (LoginForm) e a de Cadastro (RegisterForm), foi produzido o diagrama, com a ferramenta [draw.io](https://www.drawio.com/), considerando os princípios do Mediator, tal como as necessidades do projeto.
...
**4.** Testes de execução do Mediator: Após a implementação do código, foram realizados testes para validar a aplicação do GoF ao projeto nas classes LoginForm e RegisterForm.
